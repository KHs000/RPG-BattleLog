 ...
 */
public class JanelaConfiguraFichaMob extends javax.swing.JFrame {

    /**
     * Creates new form JanelaConfiguraFichaMob
     */
    public JanelaConfiguraFichaMob() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (evt.getSource() == jButton1) {
            ...
            JanelaConfiguraMob configJogador = new JanelaConfiguraMob ();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (evt.getSource() == jButton3) {
            jPanel3.remove(jTextField14);
            jPanel3.remove(jButton3);

            int linha = Integer.parseInt(jTextField14.getText());
            jPanel3.setLayout(new GridBagLayout());
            GridBagConstraints c = new GridBagConstraints ();
            c.insets = new Insets(2, 2, 2, 2);
            JTextField [] campoInv = new JTextField [linha];
            JTextField [] campoInvQuant = new JTextField [linha];
            ...
            for (int i = 0 ; i < campoInv.length ; i++) {
                ...
                jPanel3.add(campoInv[i], c);
                campoInvQuant[i] = new JTextField(3);
                c.gridy = i; c.gridx = 1;
                c.gridwidth = 1;c.fill = GridBagConstraints.HORIZONTAL;
                c.anchor = GridBagConstraints.NORTH;c.weighty = 1;
                jPanel3.add(campoInvQuant[i], c);
            }

            JButton salvar = new JButton ("Confirma");
            c.gridy = campoInv.length;c.gridx = 0;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (evt.getSource() == jButton2) {
            ...
            int linha = Integer.parseInt(jTextField13.getText());
            jPanel2.setLayout(new GridBagLayout());
            GridBagConstraints c = new GridBagConstraints ();
            c.insets = new Insets(2, 2, 2, 2);
            JTextField [] campoSkill = new JTextField [linha];
            JTextField [] campoSkillCost = new JTextField [linha];
            ...
            for (int i = 0 ; i < campoSkill.length ; i++) {
                ...
                c.gridwidth = 1;c.fill = GridBagConstraints.HORIZONTAL;
                c.anchor = GridBagConstraints.NORTH;c.weighty = 1;
                jPanel2.add(campoSkillCost[i], c);
            }

            JButton salvar = new JButton ("Confirma");
            c.gridy = campoSkill.length;c.gridx = 0;
            c.gridwidth = 2;c.fill = GridBagConstraints.HORIZONTAL;
            c.anchor = GridBagConstraints.NORTH;c.weighty = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaConfiguraFichaMob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaConfiguraFichaMob().setVisible(true);
            }
        });
    }
